...
public class BCKehoachAFYP {
    public int soTT;
    public String congty;
    public double tongcongtygiao;
    public double T1;
    public double T2;
    public double T3;
    public double Q1;
    ...
    public double Q4;
    public double canam;
    public BCKehoachAFYP(String congty, double tongcongtygiao, double t1, double t2, double t3) {
        this.congty = congty;
        this.tongcongtygiao = tongcongtygiao;
        T1 = t1;
        T2 = t2;
        T3 = t3;
    }

    public BCKehoachAFYP(String congty, double tongcongtygiao, double t1) {
        this.congty = congty;
        this.tongcongtygiao = tongcongtygiao;
        T1 = t1;
    }

    public BCKehoachAFYP(String congty, double tongcongtygiao) {
        this.congty = congty;
        this.tongcongtygiao = tongcongtygiao;
    }
    ...
    public double getTongcongtygiao() {
        return tongcongtygiao;
    }

    public void setTongcongtygiao(double tongcongtygiao) {
        this.tongcongtygiao = tongcongtygiao;
    }
